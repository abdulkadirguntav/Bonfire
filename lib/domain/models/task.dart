enum TaskCategory {
  ...
  static TaskCategory fromName(String? value) {
...
class Task {
  ...
  bool isCompletedOn(DateTime date) =>
      completedOn != null &&
      completedOn!.year == date.year &&
      completedOn!.month == date.month &&
      completedOn!.day == date.day;
  ...
  factory Task.fromJson(Map<String, dynamic> json) {
    ...
    return Task(
      ...
      scheduledDays:
          (json['scheduledDays'] as List? ?? []).cast<int>().toSet(),
      createdAt: createdAt,
      completedOn:
          DateTime.tryParse(json['completedOn'] as String? ?? '') ??
              ((json['isCompleted'] as bool? ?? false) ? createdAt : null),
      acceptedWhileExhausted:
          json['acceptedWhileExhausted'] as bool? ?? false,
  ...
  bool matchesDate(DateTime date) => scheduledDays.isNotEmpty
      ? scheduledDays.contains(date.weekday)
      : _isSameDay(createdAt, date);
